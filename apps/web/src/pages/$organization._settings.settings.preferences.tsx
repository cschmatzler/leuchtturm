				...
				<div className="mt-5 space-y-6">
					...
					{totpURI ? (
						<>
							<div className="grid gap-x-10 gap-y-2 lg:grid-cols-[1fr_2fr]">
								<div>
									<FieldLabel htmlFor="two-factor-uri">
										<T>Authenticator setup</T>
									</FieldLabel>
									<FieldDescription className="mt-1">
										<T>
											Add this setup URI to your authenticator app, then enter the code it shows.
										</T>
									</FieldDescription>
								</div>
								<div className="space-y-3">
									<Input id="two-factor-uri" value={totpURI} readOnly className="font-mono" />
									<Input
										id="two-factor-code"
										inputMode="numeric"
					...
					{backupCodes ? (
						<div className="grid gap-x-10 gap-y-2 lg:grid-cols-[1fr_2fr]">
							<div>
								...
								<FieldDescription className="mt-1">
									<T>
										Save these codes now. Each code can be used once if you lose your authenticator.
									</T>
								</FieldDescription>
							</div>
